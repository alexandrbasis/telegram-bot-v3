...
DEPARTMENT_RUSSIAN = {
    ...
    Department.CHAPEL.value: "Чапл",
    Department.SETUP.value: "Сетап",
    Department.PALANKA.value: "Паланка",
    Department.ADMINISTRATION.value: "Администрация",
    Department.KITCHEN.value: "Кухня",
    Department.DECORATION.value: "Декорации",
    Department.BELL.value: "Звонарь",
    Department.REFRESHMENT.value: "Рефрешмент",
