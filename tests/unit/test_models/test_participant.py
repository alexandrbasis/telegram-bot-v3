...
from src.models.participant import (
    Participant, Gender, Size, Role, Department, PaymentStatus
)
...
class TestParticipantEnums:
    ...
    def test_department_enum_values(self):
        ...
        departments = [
            Department.ROE, Department.CHAPEL, Department.SETUP,
            Department.PALANKA, Department.ADMINISTRATION, Department.KITCHEN,
            Department.DECORATION, Department.BELL, Department.REFRESHMENT,
            Department.WORSHIP, Department.MEDIA, Department.CLERGY, Department.RECTORATE
        ]
