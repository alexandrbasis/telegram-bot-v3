...
class TestGetListRequestHandler:
    ...
    @pytest.mark.asyncio
    async def test_handle_get_list_request_shows_role_selection(self, mock_update, mock_context):
    ...
    @pytest.mark.asyncio 
    async def test_handle_get_list_request_message_content(self, mock_update, mock_context):
...
class TestRoleSelectionHandler:
    ...
    @pytest.mark.asyncio
    async def test_handle_candidate_role_selection(self, mock_candidate_update, mock_context):
    ...
    @pytest.mark.asyncio
    async def test_role_selection_includes_pagination(self, mock_team_update, mock_context):
        ...
        main_menu_buttons = [btn for btn in buttons if btn.callback_data == "list_nav:MAIN_MENU"]
...
class TestListNavigationHandler:
    ...
    @pytest.mark.asyncio
    async def test_handle_main_menu_navigation(self, mock_main_menu_update, mock_context):
        ...
        assert (mock_main_menu_update.callback_query.edit_message_text.called or
                mock_main_menu_update.callback_query.message.reply_text.called)

    @pytest.mark.asyncio
    async def test_navigation_handler_recognizes_callback_pattern(self, mock_main_menu_update, mock_context):
