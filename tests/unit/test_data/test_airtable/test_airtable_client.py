...
def mock_table():
    ...
    table = Mock()
    table.schema.return_value = {"fields": [{"name": "TestField", "type": "singleLineText"}]}
    ...
    table.update.return_value = {"id": "rec123", "fields": {"TestField": "Updated Value"}}
...
class TestAirtableClient:
    ...
    @patch('src.data.airtable.airtable_client.Api')
    def test_table_property_lazy_initialization(self, mock_api_class, mock_config, mock_table):
