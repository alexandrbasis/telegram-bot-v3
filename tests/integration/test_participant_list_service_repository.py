...
class TestParticipantListServiceRepositoryIntegration:
    ...
    @pytest.mark.asyncio
    async def test_service_calls_repository_with_team_role(self, service, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_service_calls_repository_with_candidate_role(self, service, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_service_processes_repository_team_results(self, service, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_service_processes_repository_candidate_results(self, service, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_service_handles_empty_repository_results(self, service, mock_repository):
